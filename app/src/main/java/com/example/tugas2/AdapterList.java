...
public class AdapterList extends RecyclerView.Adapter<AdapterList.ViewHolder> {
    ...
    public AdapterList(List<com.example.tugasdrawer.DataItem> datalist, Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        com.example.tugasdrawer.DataItem dataItem= datalist.get(position);
    ...
    com.example.tugasdrawer.DataItem getItem(int id) {
